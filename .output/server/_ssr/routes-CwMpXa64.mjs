...
import { a as ChevronRight, i as EllipsisVertical, n as Play, o as ArrowLeft, r as Info, t as TrendingUp } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-CwMpXa64.js
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: [
							...
							onClick: () => setTab(item),
							className: "relative py-3 text-[15px] font-medium " + (tab === item ? "text-white" : "text-white/50"),
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											...
											children: [
												...
												className: "rounded-full border px-4 py-1.5 text-[13px] font-medium " + (viewsTab === item ? "border-white bg-white text-black" : "border-white/20 bg-transparent text-white/90"),
												children: item
											}, item))
										}),
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "mt-3 flex items-center gap-4 text-[12px] text-white",
...
function SummaryCard({ label, value, onChange }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
...
function BarRow({ label, value, onChange, pct, color = IG_PINK }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "h-[9px] flex-1 overflow-hidden rounded-full bg-white/10",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
