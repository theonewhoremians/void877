...
//#region node_modules/.nitro/vite/services/ssr/assets/router-DTGUls7N.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-f8eSibJy.css";
...
var Route$3 = createRootRouteWithContext()({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Editable Reel Insights dashboard — tap any number to edit."
			},
			{
				name: "author",
				content: "Lovable"
...
var $$splitComponentImporter$2 = () => import("./routes-CwMpXa64.mjs");
