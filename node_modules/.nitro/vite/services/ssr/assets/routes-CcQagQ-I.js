...
import { ArrowLeft, ChevronRight, Info, MoreVertical, TrendingUp } from "lucide-react";
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [hasImportedThumbnail ? /* @__PURE__ */ jsx("img", {
							src: thumb,
...
function SummaryCard({ label, value, onChange, onLabelChange }) {
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [onLabelChange ? /* @__PURE__ */ jsx(Editable, {
			value: label,
