import { t as supabase } from "./supabase-CoQutyqX.js";
...
function AdminPage() {
	...
	const invoke = useCallback(async (name, body, method = "POST") => {
	...
	const load = useCallback(async (searchQuery = debouncedQuery) => {
		if (!key.trim()) {
	...
	const replaceLicense = useCallback((updatedLicense) => {
			...
			children: [
				...
				/* @__PURE__ */ jsxs("form", {
					...
					children: [
						...
						/* @__PURE__ */ jsx("select", {
							...
							className: "rounded bg-black px-3 py-2",
							children: durations.map((item) => /* @__PURE__ */ jsx("option", {
								value: item.value,
								children: item.label
							}, item.label))
						}),
				...
				/* @__PURE__ */ jsx("div", {
					...
					children: /* @__PURE__ */ jsxs("table", {
						...
						}), /* @__PURE__ */ jsx("tbody", { children: licenses.map((license) => {
